...
--SELECT ROUND(DBMS_RANDOM.VALUE(10,110),-1) FROM DUAL; -- 10의 배수만 반환
--SELECT DBMS_RANDOM.STRING('A',5) FROM DUAL; --문자열 math.random 방식
--SELECT ROUND(DBMS_RANDOM.VALUE(1,5),0) FROM DUAL;   --숫자 math.random 방식