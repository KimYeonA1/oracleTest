...
CREATE SEQUENCE STUDENT_NO_SEQ START WITH 1 INCREMENT BY 1;

INSERT INTO STUDENT (NO,NAME,KOR,ENG,MAT) VALUES(STUDENT_NO_SEQ.NEXTVAL, '홍길동', '90', '70', '70');
INSERT INTO STUDENT(NO, NAME, KOR, ENG, MAT) VALUES (STUDENT_NO_SEQ.NEXTVAL, '김선아', '42', '77', '69');
INSERT INTO STUDENT(NO, NAME, KOR, ENG, MAT) VALUES (STUDENT_NO_SEQ.NEXTVAL, '김민아', '47', '97', '49');
COMMIT;
...
/
-- 등수를 처리하는 저장 프로시저 생성
DROP PROCEDURE STUDENT_RANK_PROC;
CREATE OR REPLACE PROCEDURE STUDENT_RANK_PROC
IS
    VSTUDENT_RT STUDENT%ROWTYPE;
    CURSOR C1 IS
    SELECT NO, NAME, TOTAL, RANK()OVER(ORDER BY TOTAL DESC) RANK FROM STUDENT ORDER BY TOTAL DESC;
BEGIN
